...
public class apo_idade_deficiente extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_apo_idade_deficiente);

        AdView mAdView = (AdView) findViewById(R.id.apo_idade_deficiente);
    ...
    public void voltar_estacionario(View view) {
        ...
        Intent secondActivity = new Intent(this, apo_idade.class);
