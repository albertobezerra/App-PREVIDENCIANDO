...
public class aux_doenca_previdenciario extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_aux_doenca_previdenciario);

        AdView mAdView = (AdView) findViewById(R.id.aux_doenca_previdenciario);
