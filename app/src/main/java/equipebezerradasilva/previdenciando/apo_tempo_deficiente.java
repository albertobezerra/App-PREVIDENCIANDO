...
public class apo_tempo_deficiente extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_apo_tempo_deficiente);

        AdView mAdView = (AdView) findViewById(R.id.apo_tempo_deficiente);
