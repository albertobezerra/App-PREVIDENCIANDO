...
public class apo_tempo_proporcional extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_apo_tempo_proporcional);

        AdView mAdView = (AdView) findViewById(R.id.apo_tempo_proporcional);
    ...
    public void voltar_estacionario(View view) {
        ...
        Intent secondActivity = new Intent(this, apo_tempo.class);
