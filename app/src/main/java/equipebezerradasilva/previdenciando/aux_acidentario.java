...
public class aux_acidentario extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_aux_acidentario);

        AdView mAdView = (AdView) findViewById(R.id.aux_acidentario);
