...
public class apo_idade_urbana extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_apo_idade_urbana);


        AdView mAdView = (AdView) findViewById(R.id.apo_idade_urbana);
