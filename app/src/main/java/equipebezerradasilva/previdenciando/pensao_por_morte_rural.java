...
public class pensao_por_morte_rural extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pensao_por_morte_rural);

        AdView mAdView = (AdView) findViewById(R.id.pensao_por_morte_rural);
